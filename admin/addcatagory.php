                                            ...
                                            <CENTER>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" id="cat_name" name="cat_name" type="text" value="" placeholder="ชื่อหมวดหมู่" />
                                                        <label for="inputName">ชื่อหมวดหมู่</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                        <button type="submit" name="Newcatagory" style="width:130px; height:60; font-size:17px;" class="btn btn-success">ยันยัน</button>
