            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container px-4 px-lg-5 mt-5">
                        ...
                        <div class="card">
                        <div class="tab">
                            <button class="tablinks" onclick="openCity(event, 'all')" id="defaultOpen">รายงานปัญหาร้านค้าทั้งหมด</button>
                            <button class="tablinks" onclick="openCity(event, 'noread')">รายงานปัญหาร้านค้าที่ยังไม่ได้อ่าน</button>
                            <button class="tablinks" onclick="openCity(event, 'read')">รายงานปัญหาร้านค้าที่อ่านแล้ว</button>
                        </div>
                                ...
                                <table id="allTable">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $repShop = $sql->reportshop();
                                            while($RepShop=mysqli_fetch_array($repShop)){
                                        ?>
                                        <tr>
                                            <td><img class="card-img" src="\roengrang\img/<?=$RepShop['shop_img']?>.jpg" style="width: 96px;hieght: 96px;"  /></td>
                                            <td><?=$RepShop['shop_name']?></td>
                                            <td><?=$RepShop['user_fullname']?></td>
                                            <td>
                                                <div>รายงานเมื่อ</div>
                                                <div><?=$RepShop['report_date']?></div>
                                                <?php
                                                    if ($RepShop['report_status']==1){
                                                ?>   
                                                <div>อ่านเมื่อ</div>
                                                <div><?=$RepShop['recieve_date']?></div>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <div>
                                ...
                                <table id="noTable">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $repShopN = $sql->reportshopNoRead();
                                            while($RepShopN=mysqli_fetch_array($repShopN)){
                                        ?>
                                        <tr>
                                            <td><img class="card-img" src="\roengrang\img/<?=$RepShopN['shop_img']?>.jpg" style="width: 96px;hieght: 96px;"  /></td>
                                            <td><?=$RepShopN['shop_name']?></td>
                                            <td><?=$RepShopN['user_fullname']?></td>
                                            <td>
                                                <div>รายงานเมื่อ</div>
                                                <div><?=$RepShopN['report_date']?></div>
                                                <?php
                                                    if ($RepShopN['report_status']==1){
                                                ?>   
                                                <div>อ่านเมื่อ</div>
                                                <div><?=$RepShopN['recieve_date']?></div>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <div>
                                ...
                                <table id="readTable">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $repShopR = $sql->reportshopRead();
                                            while($RepShopR=mysqli_fetch_array($repShopR)){
                                        ?>
                                        <tr>
                                            <td><img class="card-img" src="\roengrang\img/<?=$repShopR['shop_img']?>.jpg" style="width: 96px;hieght: 96px;"  /></td>
                                            <td><?=$repShopR['shop_name']?></td>
                                            <td><?=$repShopR['user_fullname']?></td>
                                            <td>
                                                <div>รายงานเมื่อ</div>
                                                <div><?=$repShopR['report_date']?></div>
                                                <?php
                                                    if ($repShopR['report_status']==1){
                                                ?>   
                                                <div>อ่านเมื่อ</div>
                                                <div><?=$repShopR['recieve_date']?></div>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <div>
