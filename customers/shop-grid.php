				...
				<div class="row">
					...
					<div class="col-lg-7 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								<li><i class="ti-bag"></i> <a href="#">ร้านค้าของฉัน</a></li>
								<li><i class="ti-user"></i> <a href="#">บัญชีผู้ใช้่</a></li>
					...
					<div class="col-lg-2 col-md-3 col-12">
						<div class="right-bar">
							...
							<div class="sinlge-bar">
								 <a href="#"><i class="fa fa-heart" aria-hidden="true"></i> สินค้าที่ถูกใจ</a>
							</div>
							<div class="sinlge-bar shopping">
								<a href="#" class="single-icon"><i class="ti-shopping-cart-full"></i> <span class="total-count">2</span></a>
								<!-- Shopping Item -->
								<div class="shopping-item">
									...
									<ul class="shopping-list">
										<li>
											...
											<p class="quantity">1x - <span class="amount">99.00 บาท</span></p>
										</li>
										<li>
											<a href="#" class="remove" title="Remove this item"><i class="fa fa-remove"></i></a>
											<a class="cart-img" href="#"><img src="https://via.placeholder.com/70x70" alt="#"></a>
											<h4><a href="#">Woman Necklace</a></h4>
											<p class="quantity">1x - <span class="amount">35.00 บาท</span></p>
										</li>
									</ul>
									<div class="bottom">
										<div class="total">
											<span>รวม</span>
											<span class="total-amount">134.00 บาท</span>
										</div>
