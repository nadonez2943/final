...
<body>
    ...
    <div class="container">
        <form class="card" action="reglog_upload.php" method="POST" enctype="multipart/form-data">
        ...
        <hr>
            ...
            <p class="mt-3" ALIGN="center" >
                <button type="submit" name="RegWord" class="btn btn-primary">สมัคสมาชิก</button>
            </p> 
        </form>
    </div>
